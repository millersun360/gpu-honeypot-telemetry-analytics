...
This project evaluates whether NVIDIA accelerated computing can improve the processing of high-volume honeypot telemetry, with a focus on SSH brute-force login activity collected by Cowrie and similar to data submitted to the SANS Internet Storm Center DShield project.
